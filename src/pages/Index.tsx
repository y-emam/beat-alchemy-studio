...
import { ArrowRight, Play, Heart, Award, Music, Headphones, Users } from 'lucide-react';
  ...
  const WaveformAnimation = () => (
    <div className="flex items-end h-12 mx-auto my-6">
      {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
        <div 
          key={i}
          className={`waveform-bar h-${Math.ceil(Math.random() * 12)} animate-waveform-${(i % 5) + 1}`}
        />
      ))}
    </div>
  );
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-1/2 space-y-6 animate-fade-in">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Crafting <span className="text-primary">Sonic Masterpieces</span> for Modern Artists
              </h1>
              <p className="text-lg text-muted-foreground max-w-lg">
                Premium beats crafted with precision. Elevate your sound with Beat Alchemy's professionally engineered productions.
              </p>
              ...
              <div key={beat.id} className="beat-card">
                ...
                <div className="beat-card-content">
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <span className="text-sm text-muted-foreground">{beat.genre} • {beat.bpm} BPM</span>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                With over 10 years of production experience, Beat Alchemy has worked with major artists across the industry. Our beats have been featured in chart-topping albums, commercials, and video games.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold">Grammy-Nominated Productions</h4>
                    <p className="text-sm text-muted-foreground">Our beats have been featured in Grammy-nominated albums</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Professional mixing and mastering for every beat</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Over 1 million streams across major platforms</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:w-1/2">
              <div className="grid grid-cols-2 gap-4">
                <div className="aspect-square rounded-lg overflow-hidden">
                  <img src="/images/beat-cover-2.jpg" alt="Studio session" className="w-full h-full object-cover" />
                </div>
                <div className="aspect-square rounded-lg overflow-hidden mt-8">
                  <img src="/images/beat-cover-3.jpg" alt="Production equipment" className="w-full h-full object-cover" />
                </div>
                <div className="aspect-square rounded-lg overflow-hidden -mt-8">
                  <img src="/images/beat-cover-4.jpg" alt="Mixing console" className="w-full h-full object-cover" />
                </div>
                <div className="aspect-square rounded-lg overflow-hidden">
                  <img src="/images/beat-cover-5.jpg" alt="Artist collaboration" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-primary/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            Explore our premium beats collection and find the perfect sound for your next hit.
          </p>
          <Button size="lg" asChild>
